 ...
 * Use the {@link Friends_list_Fragment#newInstance} factory method to
...
public class Friends_list_Fragment extends Fragment {
     ...
     * @return A new instance of fragment Friend_list_Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Friends_list_Fragment newInstance(String param1, String param2) {
        Friends_list_Fragment fragment = new Friends_list_Fragment();
                ...
                UsersRef.child(usersIDs).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.hasChild("fullName")){
                            String friendName = snapshot.child("fullName").getValue().toString();
                            String friendOccupation = snapshot.child("occupation").getValue().toString();

                            holder.userName.setText(friendName);
                            holder.userOccupation.setText(friendOccupation);
                        }
